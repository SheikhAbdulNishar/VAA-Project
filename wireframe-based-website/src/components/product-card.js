const ProductCard = () => {
    return (  
        <div className="productMenu row">
            <div className="product1 col-lg-6">
                <Card 
            ...
            <div className="product2 col-lg-6">
                <Card 
            ...
            <div className="product3 col-lg-6">
                <Card 
            ...
            <div className="product4 col-lg-6">
                <Card 
            ...
            <div className="product5 col-lg-6">
                <Card 
            ...
            <div className="product6 col-lg-6">
                <Card 
...
function Card(props){
    return(
        <div class="card mb-3" style={{width: "34rem"}}>
            <div class="row g-0">
                <div class="col-md-4">
                 <img src={props.img} class="cardImage img-fluid rounded-start" alt="..." />
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">{props.name}</h5>
                        <p class="cardDescription card-text">{props.description}</p>
                        <p class="CardReview card-text">{props.rating}{props.reviews}</p>
                        <p class="cardPrice card-text"><small class="text-muted">{props.price}</small></p>
                    </div>
                </div>
            </div>
        </div>
